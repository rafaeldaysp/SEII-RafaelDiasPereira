...
FILE_PORT = 5005        #   especifica a porta para arquivos
DATA_PORT = 5006        #   especifica a porta para dados
...
try:                    #   tenta executar o código
    ...
    sock.send(file_name)                 # envia o arquivo para o host
    ...
    sock.send(data)                      # envia o arquivo lido para o host
